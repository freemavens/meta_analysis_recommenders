...
shinyUI(fluidPage(
  ...
  titlePanel(
    fluidRow(
      column(6, align="left", style="margin-top:55px;margin-left:30px", "Perfect Blend: Ad Testing Predictive Service"),
      column(5, tags$a(href="https://freemavens.com/", tags$img(height = 150, width = 550, src = "Master-whitespace-small.png")))
